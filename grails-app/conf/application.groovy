...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'lecoincoin4.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'lecoincoin4.UserRole'
grails.plugin.springsecurity.authority.className = 'lecoincoin4.Role'
